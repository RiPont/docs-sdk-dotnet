...
The latest version, as of April 29th, 2021, is 1.0.0.
See xref:pages:distributed-transactions-dotnet-release-notes.adoc[Release Notes] for the latest version.
